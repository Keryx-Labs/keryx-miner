...
mod tests {
    ...
    fn test_heavy_hash() {
        let expected_hash = Hash::from_le_bytes([
            178, 101, 253, 94, 61, 63, 163, 211, 32, 243, 219, 71, 156, 142, 30, 187, 110, 120, 204, 88, 234, 105, 27,
            70, 148, 93, 226, 28, 116, 230, 27, 246,
        ]);
        #[rustfmt::skip]
        let _legacy_test_matrix = Matrix([
        ...
        let test_matrix = Matrix::generate(Hash::from_le_bytes([42; 32]), 1);
    ...
    fn test_generate_matrix() {
        #[rustfmt::skip]
        let _legacy_expected_matrix = Matrix([
        ...
        assert_eq!(
            matrix.0[0],
            [
                1, 15, 8, 4, 9, 4, 1, 3, 9, 3, 0, 5, 8, 10, 4, 9, 4, 15, 14, 2, 15, 0, 1, 11, 9, 14, 4, 0, 11, 15, 11,
                15, 11, 8, 2, 6, 0, 4, 1, 4, 5, 6, 9, 1, 13, 5, 6, 11, 12, 14, 7, 7, 4, 10, 13, 8, 12, 9, 13, 11, 1, 2,
                3, 2,
            ]
        );
    }
