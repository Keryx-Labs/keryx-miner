...
mod tests {
    ...
    #[test]
    fn detects_sticky_cuda_faults() {
        assert!(is_sticky_gpu_runtime_fault("CUDA_ERROR_ILLEGAL_ADDRESS"));
        assert!(is_sticky_gpu_runtime_fault("illegal memory access was encountered"));
